...
// #include <Runtime.PPCEABO.H/Gecko_setjmp.h> // IWYU pragma: export

/*
 * Layout: __setjmp (0x800F6460), __longjmp (0x800F6564)
 * Size:   luaD_breakrun (0x80160FEC), luaD_runprotected (0x80161044)
 */
